...
EInternacional::EInternacional(string ced, string nom, string ape, string num, string uni, string cod, string ult, string nac, string numPas, string cond):Estudiante(ced, nom, ape, num, uni, cod, ult ), nacionalidad(nac), numPasaporte(numPas), condicion(cond) {}
